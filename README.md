...
An AI-p**KeplerFlow** is a machine learning system designed to discover and classify exoplanets using data from NASA's Kepler, K2, and TESS missions. By implementing ensemble methodologies, it achieves high precision in distinguishing between confirmed exoplanets and false positives.
 with high accuracy.

## Features

- **Advanced Ensemble Model**: Combines Random Forest, XGBoost, LightGBM, Gradient Boosting, and ExtraTrees classifiers.
- **Superior Performance**: Achieves ~82% accuracy with high ROC-AUC scores through feature engineering.
